module char_positioning(
    input game_clk,
    input rst,
    input [2:0] p_facing_left_state,   // P2 State (Sağdaki Karakter)
    input [2:0] p_facing_right_state,  // P1 State (Soldaki Karakter)
    output reg [9:0] px_facing_left,   // P2 X Koordinatı
    output reg [9:0] px_facing_right   // P1 X Koordinatı
);
